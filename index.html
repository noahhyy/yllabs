...
<div class="wrap">
  ...
  <section id="features" class="section">
    ...
    <div class="features">
      <div class="card">
        <h3>🎟 Tickets</h3>
        <p>Support system that just works. no spam, no mess, just quick replies + tracking.</p>
      </div>
      <div class="card">
        <h3>⚖️ Infractions</h3>
        <p>Clear logs + fair actions. Keep your space safe without overcomplicating it.</p>
      </div>
      <div class="card">
        <h3>💬 YLLABS Feed</h3>
        <p>A timeline for your community. Roleplay vibes, casual posts, keeps people engaged.</p>
      </div>
    </div>
  </section>
